    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sueldo_mensual', models.DecimalField(blank=True, max_digits=19, decimal_places=4, null=True)),
                ...
                ('sueldo_mensual_alumno', models.DecimalField(blank=True, max_digits=19, decimal_places=4, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, auto_created=True, verbose_name='ID', primary_key=True)),
                ('primera', models.DecimalField(max_digits=3, blank=True, verbose_name='1ra Calificacion', decimal_places=0, null=True)),
                ('status1', models.IntegerField(blank=True, verbose_name='Status', null=True)),
                ('segunda', models.DecimalField(max_digits=3, blank=True, verbose_name='2da Calificacion', decimal_places=0, null=True)),
                ('status2', models.IntegerField(blank=True, verbose_name='Status', null=True)),
                ('tercera', models.DecimalField(max_digits=3, blank=True, verbose_name='3ra Calificacion', decimal_places=0, null=True)),
                ('status3', models.IntegerField(blank=True, verbose_name='Status', null=True)),
                ('cuarta', models.DecimalField(max_digits=3, blank=True, verbose_name='4ta Calificacion', decimal_places=0, null=True)),
                ('status4', models.IntegerField(blank=True, verbose_name='Status', null=True)),
                ('quinta', models.DecimalField(max_digits=3, blank=True, verbose_name='5ta Calificacion', decimal_places=0, null=True)),
                ('status5', models.IntegerField(blank=True, verbose_name='Status', null=True)),
                ('sexta', models.DecimalField(max_digits=3, blank=True, verbose_name='6ta Calificacion', decimal_places=0, null=True)),
                ('status6', models.IntegerField(blank=True, verbose_name='Status', null=True)),
                ('final', models.DecimalField(max_digits=3, blank=True, verbose_name='Calificacion Final', decimal_places=0, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('municipio', models.CharField(max_length=50, blank=True, null=True)),
                ('clave', models.CharField(max_length=50, blank=True, unique=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lat', models.DecimalField(blank=True, max_digits=10, decimal_places=7, null=True)),
                ('lng', models.DecimalField(blank=True, max_digits=10, decimal_places=7, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('baja_date_created', models.DateTimeField(blank=True, null=True)),
                ('is_active', models.BooleanField(default=True)),
                ('profesor', models.ForeignKey(to_field='no_expediente', to='academica.Maestros', blank=True, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, auto_created=True, verbose_name='ID', primary_key=True)),
                ('monto', models.DecimalField(blank=True, max_digits=18, decimal_places=2, null=True)),
                ('alta_date_created', models.DateTimeField(auto_now_add=True)),
                ('baja_date_created', models.DateTimeField(blank=True, null=True)),
                ('is_active', models.BooleanField(default=True)),
                ('alumno', models.ForeignKey(to='academica.Alumnos')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(verbose_name='Escuela', to='academica.Escuela', blank=True, null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='alumnos',

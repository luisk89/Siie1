    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lugar_nac', models.CharField(max_length=50, null=True, verbose_name='Lugar de nacimiento', blank=True)),
                ...
                ('anio_egreso', models.CharField(max_length=5, null=True, verbose_name='Egreso', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('promedio_80_84', models.CharField(max_length=50, null=True, blank=True)),
                ('promedio_85_89', models.CharField(max_length=50, null=True, blank=True)),
                ('promedio_90_94', models.CharField(max_length=50, null=True, blank=True)),
                ('promedio_95_100', models.CharField(max_length=50, null=True, blank=True)),
                ('alta_date_created', models.DateTimeField(auto_now_add=True)),
                ('baja_date_created', models.DateTimeField(null=True, blank=True)),
                ('is_active', models.BooleanField(default=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, auto_created=True, verbose_name='ID', primary_key=True)),
                ('observacion', models.CharField(max_length=250, null=True, verbose_name='Observaciones', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, auto_created=True, verbose_name='ID', primary_key=True)),
                ('primera', models.DecimalField(null=True, max_digits=3, verbose_name='1ra Calificacion', blank=True, decimal_places=0)),
                ('status1', models.IntegerField(null=True, verbose_name='Status', blank=True)),
                ('segunda', models.DecimalField(null=True, max_digits=3, verbose_name='2da Calificacion', blank=True, decimal_places=0)),
                ('status2', models.IntegerField(null=True, verbose_name='Status', blank=True)),
                ('tercera', models.DecimalField(null=True, max_digits=3, verbose_name='3ra Calificacion', blank=True, decimal_places=0)),
                ('status3', models.IntegerField(null=True, verbose_name='Status', blank=True)),
                ('cuarta', models.DecimalField(null=True, max_digits=3, verbose_name='4ta Calificacion', blank=True, decimal_places=0)),
                ('status4', models.IntegerField(null=True, verbose_name='Status', blank=True)),
                ('quinta', models.DecimalField(null=True, max_digits=3, verbose_name='5ta Calificacion', blank=True, decimal_places=0)),
                ('status5', models.IntegerField(null=True, verbose_name='Status', blank=True)),
                ('sexta', models.DecimalField(null=True, max_digits=3, verbose_name='6ta Calificacion', blank=True, decimal_places=0)),
                ('status6', models.IntegerField(null=True, verbose_name='Status', blank=True)),
                ('final', models.DecimalField(null=True, max_digits=3, verbose_name='Calificacion Final', blank=True, decimal_places=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('anio', models.IntegerField(null=True, verbose_name='Año', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('municipio', models.CharField(max_length=50, null=True, blank=True)),
                ('clave', models.CharField(max_length=50, null=True, unique=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, auto_created=True, verbose_name='ID', primary_key=True)),
                ('nom_materia', models.CharField(max_length=50, null=True, blank=True)),
                ('clave', models.CharField(max_length=50, null=True, unique=True, blank=True)),
                ('tipo', models.CharField(max_length=50, null=True, blank=True)),
                ('alta_date_created', models.DateTimeField(auto_now_add=True)),
                ('baja_date_created', models.DateTimeField(null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=75, unique=True, default='email@email.com')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('baja_date_created', models.DateTimeField(null=True, blank=True)),
                ('is_active', models.BooleanField(default=True)),
                ('profesor', models.ForeignKey(null=True, to_field='no_expediente', blank=True, to='academica.Maestros')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='materias',
            name='semestre',
            field=models.ForeignKey(null=True, to_field='clave', blank=True, to='academica.Semestre'),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='grupos',
            name='plan',
            field=models.ForeignKey(null=True, to_field='clave_plan', blank=True, to='academica.PlanEstudio'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='grupos',
            name='semestre',
            field=models.ForeignKey(null=True, to_field='clave', blank=True, to='academica.CicloSemestral'),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='bajas',
            name='matricula',
            field=models.ForeignKey(null=True, to_field='matricula', blank=True, to='academica.Alumnos'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='alumnos',
            name='carrera',
            field=models.ForeignKey(null=True, to_field='clave', blank=True, to='academica.Carreras'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='alumnos',
            name='escuela_procedencia',
            field=models.ForeignKey(null=True, verbose_name='Escuela', blank=True, to='academica.Escuela'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='alumnos',
        ...
        migrations.AddField(
            model_name='alumnos',
            name='grupo',
            field=models.ForeignKey(null=True, to_field='clave', blank=True, to='academica.Grupos'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='alumnos',
